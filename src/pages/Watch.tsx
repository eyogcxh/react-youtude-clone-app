...
const Watch = () => {
  ...
  const currentPlaying = useAppSelector((state) => state.clonetubeApp.currentPlaying)
  const recomendedVideos = useAppSelector((state) => state.clonetubeApp.recommendedVideos)
